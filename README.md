...
To build the final jar and optimize the FBAHirsche application for production, run:
...
Then navigate to [http://localhost:8762](http://localhost:8762) in your browser.
